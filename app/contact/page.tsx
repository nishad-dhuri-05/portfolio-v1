...
const info=[
  {
    icon:<FaPhoneAlt/>,
    title:"Phone",
    description:"(+91) 9969801629"
  },
  {
    icon:<FaEnvelope/>,
    title:"Email",
    description:"nhdhuri24@gmail.com"
  },
  {
    icon:<FaMapMarkerAlt/>,
    title:"Address",
...
const Contact = () => {
  return (
    ...
    className="py-6 xl:w-[70%] justify-center items-center mx-auto"
    >
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl" action="">
              ...
              <p className="text-white/60 ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                A est nam laudantium delectus, labore dolorem repellendus, 
                aperiam animi voluptatibus corrupti numquam harum sint maxime consequatur possimus quos quod quasi voluptate!
              </p>
              {/* input */}
